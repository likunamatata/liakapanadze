    ...
    return (
      <div className="HeaderTop">
        <div className="HeaderTopLeft">
          <a onClick={()=> alert("Sorry, I can't save you")}>
          ...
          <a onClick={()=> alert("What is done cannot be undone on the World Wide Web")}>
          ...
          <a onClick={()=> alert("One more chance, Biggie give me one more chance")}>
